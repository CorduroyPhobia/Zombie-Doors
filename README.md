...
A Fabric mod for Minecraft 26.1.1, created by **Corduroy Phobia**.
...
26.1.1, Java 25, and Fabric Loader 0.19.3 or later.
...
The result is `build/libs/zombie-doors-0.1.0+mc26.1.1.jar`. Dependency versions are in
`gradle.properties`.
