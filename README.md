...
A Fabric mod for Minecraft 26.2, created by **Corduroy Phobia**.
...
26.2, Java 25, and Fabric Loader 0.19.5 or later.
...
The result is `build/libs/zombie-doors-0.1.0+mc26.2.jar`. Dependency versions are in
`gradle.properties`.
